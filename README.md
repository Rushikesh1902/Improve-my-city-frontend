...
Purpose
This repository describes the intended backend for CivicEye. For the hackathon demo we provided a static frontend. The backend here is a mock Node.js structure and API design for future implementation.
